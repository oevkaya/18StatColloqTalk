...
- Data are observations or measurements (unprocessed or processed) of various data types: numbers, characters, factors, dates, etc. A dataset is a structured collection of data associated with a unique body of work.
...
- Data Representation: The form in which data is stored and communicated, might differ in various ways.
...
For data visualizaiton task, we can imagine the nested model of the data visualisation design process
...
- Visual marks/channels/variables
- Mapping data types to in different visual channels
...
> *"Data and information visualization is concerned with showing quantitative and qualitative information, so that a viewer can see
patterns, trends or anomalies, constancy or variation, in ways that other forms—text and tables—do not allow" --- Michael Friendly*
...
- In my view, R seems still more powerful compared to python regarding the available tools
