---
title: "Veri Görselleştirmenin Önemine dair"
...
```{r, out.width='50%', fig.align='center'}
knitr::include_graphics("NHS_breastcancer.jpg")
```
...
- R ve pythonda olan paket ve örneklerin hangi durumlarda nasıl işe yarayacağı ara ara düzenli okuma ve takiplerle bir düzenli takip alışkanlığına getirilebilri
...
```{r, out.width='30%', fig.align='center'}
knitr::include_graphics("HerkeseBilim_Ex.jpg")
```
...
```{r, out.width='50%', fig.align='center'}
knitr::include_graphics("HerkeseBilim_Ex2.jpg")
```
...
```{r, out.width='50%', fig.align='center'}
knitr::include_graphics("Oksijen_Ex.jpg")
```
